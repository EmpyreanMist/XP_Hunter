...
public class Sound {
    ...
    public Sound() {
        ...
        soundURL[20] = getClass().getResource("/sound/chippwall.wav");
    ...
    public void setFile(int i) {
        ...
        try {
            ...
            e.printStackTrace(); // åtminstone detta
            throw new RuntimeException("Failed to load sound index " + i + " (" + soundURL[i] + ")", e);
        }
    }
